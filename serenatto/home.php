...
<body>
    <main>
        ...
        <section class="container-table">
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="botao-editar" name="pedido_cafe" style="background-color: green;" href="pedido_cafe.php?id_pedido_cafe=<?php echo $key['id'];?>">Pedir</a>
                        </td>
                        <td>
                            <form method="POST">
                    ...
                    <tr>
                        ...
                        <td><?php echo 'R$ ' . $formatar_preco;?></td>
                        <td>
                            <a class="botao-editar" name="pedido_almoco" style="background-color: green;" href="pedido_almoco.php?id_pedido_almoco=<?php echo $key['id'];?>">Pedir</a>
                        </td>
                        <td>
                            <form method="POST">
            ...
            <button class="botao-cadastrar" name="confirmar_pedidos">Confirmar Pedido(s)</button>
