...
<head>
    ...
    <title>Serenatto - Administrador</title>
</head>
<body>
    <main>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a class="botao-editar" href="editar_produto_cafe.php?id=<?php echo ($key['id']);?>">Editar</a></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><?php echo 'R$ ' . $formatar_preco;?></td>
                    <td>
                        <a class="botao-editar" href="editar_produto_almoco.php?id=<?php echo ($key['id']);?>">Editar</a>
                    </td>
                    <td>
        ...
        <form action="baixar_relatorio.php" method="POST">
            <input type="submit" class="botao-cadastrar" value="Relatório Baixar"/>
        </form>
        </section>
        <br>
    </main>
