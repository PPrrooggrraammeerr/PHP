...
if (isset($_POST['email_session'], $_POST['senha_session'])) {
	...
	$user_one = [
		...
		'email_armazenado' => 'email_one@email.com',
	    'senha_armazenada' => 'senha_one'

	];

    $user_two = [

        'email_armazenado' => 'email_two@email.com',
        'senha_armazenada' => 'senha_two'

    ];

    $user_three = [

        'email_armazenado' => 'email_three@email.com',
        'senha_armazenada' => 'senha_three' 
	...
	$user_five = [
        ...
        'email_armazenado' => 'email_five@email.com',
        'senha_armazenada' => 'senha_five' 

    ];
	
    $allUsers = [$user_one, $user_two, $user_three, $user_four, $user_five];
    ...
    foreach ($allUsers as $user) {
        ...
        if ($email_informado === $user['email_armazenado'] && $senha_informada === $user['senha_armazenada']) {
